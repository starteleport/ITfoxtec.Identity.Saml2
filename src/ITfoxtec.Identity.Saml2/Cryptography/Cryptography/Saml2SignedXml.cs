...
using RSAPKCS1SHA256SignatureDescription = ITfoxtec.Saml2.Cryptography.RSAPKCS1SHA256SignatureDescription;

namespace ITfoxtec.Identity.Saml2.Cryptography.Cryptography
{
